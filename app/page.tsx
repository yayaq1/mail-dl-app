...
export default function Home() {
  return (
    <div className="bg-gray-50 dark:bg-[#0A0A0A] text-gray-900 dark:text-[#F7F7F7] min-h-screen">
      <SmoothScroll>
        <LandingHeader />
          ...
          <section className="py-24 px-6 text-center bg-gray-50 dark:bg-[#0A0A0A]">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <a
                  href="/app"
                  className="px-8 py-4 bg-[#2C64FF] text-white text-base font-medium rounded-full hover:bg-[#2C64FF]/90 hover:shadow-lg hover:shadow-[#2C64FF]/20 transition-all duration-200 inline-block"
                >
                  Try It Free
                </a>
                <a
                  ...
                  className="px-8 py-4 border border-gray-300 dark:border-white/20 text-gray-900 dark:text-[#F7F7F7] text-base font-medium rounded-full hover:border-[#2C64FF]/50 hover:bg-[#2C64FF]/5 transition-all duration-200 inline-block"
                >
                  View on GitHub
                </a>
              </div>
